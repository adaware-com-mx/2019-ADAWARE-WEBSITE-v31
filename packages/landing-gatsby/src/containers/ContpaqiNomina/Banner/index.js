...
const BannerImage = PORTFOLIO_SHOWCASE[1].portfolioItem[0].BannerImage; 
...
const ModalContent = () => (
  <VideoWrapper>
    <iframe
      title="Video"
      src={PORTFOLIO_SHOWCASE[1].portfolioItem[0].Youtube}
      frameBorder="0"
    />
  </VideoWrapper>
);
      ...
      <Container>
        <Box {...row}>
          <Box {...contentWrapper}>
            ...
            <Heading
              {...title}
              content={PORTFOLIO_SHOWCASE[1].portfolioItem[0].title}
            />
            <Text
              {...description}
              content={PORTFOLIO_SHOWCASE[1].portfolioItem[0].description}
            />
            <Box {...buttonWrapper}>
              <Button 
                {...button}
