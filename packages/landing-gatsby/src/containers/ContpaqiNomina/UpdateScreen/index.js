...
import { SCREENSHOTS2, PORTFOLIO_SHOWCASE }  from 'common/src/data/SaasModern/index'; 
    ...
    <SectionWrapper id="screenshot_section">
      <Container>
        <Box {...secTitleWrapper}>
          ...
          <Heading
            {...secHeading}
            content={PORTFOLIO_SHOWCASE[1].portfolioItem[0].subtitulo}
          />
        </Box>
        <Tabs
