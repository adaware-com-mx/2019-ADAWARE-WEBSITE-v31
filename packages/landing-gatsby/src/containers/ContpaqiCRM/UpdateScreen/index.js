...
import { SCREENSHOTS10, PORTFOLIO_COMERCIAL }  from 'common/src/data/SaasModern/index';
    ...
    <SectionWrapper id="screenshot_section">
      <Container>
        <Box {...secTitleWrapper}>
          ...
          <Heading
            {...secHeading}
            content={PORTFOLIO_COMERCIAL[5].portfolioItem[0].subtitulo}
          />
        </Box>
        <Tabs
